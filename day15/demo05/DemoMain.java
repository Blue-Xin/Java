...
//        MyInterface some = new MyInterface();//错误写法
        ...
        MyInterface obj = new MyInterface() {
            @Override
            public void method1() {
                System.out.println("匿名内部类实现的方法！AAA111");
            }

            @Override
            public void method2() {
                System.out.println("匿名内部类实现的方法！AAA222");
            }
        };
        obj.method1();
        obj.method2();
        ...
        new MyInterface() {
            @Override
            public void method1() {
                System.out.println("匿名内部类实现的方法！BBB111");
            }

            @Override
            public void method2() {
                System.out.println("匿名内部类实现的方法！BBB222");
            }
        }.method1();
